...
export function buildPresHTML(state) {
    ...
    <div data-pres-slide="21" data-pres-label="Schéma réseau Siège" class="flex-1 min-h-0 overflow-y-auto w-full h-full">
      <div class="max-w-6xl mx-auto px-4 py-5 space-y-4">
        ...
        <div class="glass-panel rounded-xl p-5">
          <svg class="pres-schema-svg pres-wow-svg" viewBox="0 0 680 530" role="img" preserveAspectRatio="xMidYMid meet"><title>Schéma réseau du siège GSBLAB</title><defs>
  ...
  <linearGradient id="metal-indigo" x1="0%" y1="0%" x2="100%" y2="100%">
    <stop offset="0%" stop-color="#1e1b4b" />
    <stop offset="100%" stop-color="#0c1235" />
  </linearGradient>
  <linearGradient id="metal-emerald" x1="0%" y1="0%" x2="100%" y2="100%">
    <stop offset="0%" stop-color="#064e3b" />
    <stop offset="100%" stop-color="#022c22" />
  </linearGradient>

  <style>
    .pres-wow-svg .line-draw {
      stroke-dasharray: 1000;
      stroke-dashoffset: 1000;
      animation: drawLine 1s ease-out forwards;
    }
    .pres-wow-svg .marching-ants {
      stroke-dasharray: 8 6;
      animation: march 1s linear infinite;
    }
    .pres-wow-svg .pulse {
      animation: pulseOp 2s infinite alternate;
    }
    .pres-wow-svg .hover-scale {
      transition: transform 0.3s ease, filter 0.3s ease;
      transform-origin: center;
    }
    .pres-wow-svg .hover-scale:hover {
      transform: scale(1.03);
      filter: drop-shadow(0 0 15px rgba(99,102,241,0.6));
    }
    .pres-wow-svg .wifi-wave {
      animation: radiate 2s infinite ease-out;
      transform-origin: center;
    }
    .pres-wow-svg .wifi-wave:nth-child(2) { animation-delay: 0.6s; }
    .pres-wow-svg .wifi-wave:nth-child(3) { animation-delay: 1.2s; }
    ...
    .pres-wow-svg .shield-hds {
      animation: shieldPulse 3s infinite alternate ease-in-out;
    }
    @keyframes shieldPulse {
      0% { filter: drop-shadow(0 0 5px #10b981); opacity: 0.7; }
      100% { filter: drop-shadow(0 0 20px #10b981); opacity: 1; }
    }
  </style>
</defs>
  ...
  const presSlide5 = `
    <div data-pres-slide="23" data-pres-label="Schéma réseau Laboratoire" class="flex-1 min-h-0 overflow-y-auto w-full h-full">
      <div class="max-w-6xl mx-auto px-4 py-5 space-y-4">
        ...
        <div class="glass-panel rounded-xl p-5">
          <svg class="pres-schema-svg pres-wow-svg" viewBox="0 0 680 430" role="img" preserveAspectRatio="xMidYMid meet"><title>Schéma réseau laboratoire régional GSBLAB</title><defs>
  <!-- Cyberpunk background grid -->
  <pattern id="grid" width="40" height="40" patternUnits="userSpaceOnUse">
    <path d="M 40 0 L 0 0 0 40" fill="none" stroke="rgba(99,102,241,0.05)" stroke-width="1"/>
  </pattern>
  ...
  const presSlide7 = `
    <div data-pres-slide="25" data-pres-label="Schéma réseau Centre" class="flex-1 min-h-0 overflow-y-auto w-full h-full">
      <div class="max-w-6xl mx-auto px-4 py-5 space-y-4">
        ...
        <div class="glass-panel rounded-xl p-5">
          <svg class="pres-schema-svg pres-wow-svg" viewBox="0 0 680 415" role="img" preserveAspectRatio="xMidYMid meet"><title>Schéma réseau centre de prélèvement GSBLAB</title><defs>
  <!-- Cyberpunk background grid -->
  <pattern id="grid" width="40" height="40" patternUnits="userSpaceOnUse">
    <path d="M 40 0 L 0 0 0 40" fill="none" stroke="rgba(99,102,241,0.05)" stroke-width="1"/>
  </pattern>
